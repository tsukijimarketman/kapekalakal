  ...
  useEffect(() => {
    ...
    const fetchTx = async () => {
      try {
        ...
        const completedTransactions = list.filter(
    ...
    return (
      <div className="p-8 text-center">
        ...
        <div className="text-[#7a4e2e] dark:text-[#d0b274] text-sm mt-2">
          Successfully delivered orders will appear here
        </div>
      </div>
    );
  }
    ...
    <div className="p-4 space-y-4">
      ...
      {filteredTransactions.length === 0 && searchTerm ? (
        ...
        filteredTransactions.map((tx) => {
          ...
          const title = first
            ? `${first.name}${restCount ? ` +${restCount} more` : ""}`
            : "Order";
                ...
                <div className="mt-4 pt-3 border-t border-[#e1d0a7] dark:border-[#7a4e2e]">
                  <div className="flex justify-between items-center">
                    <div className="flex-1">
                      ...
                      {(tx.completedAt || tx.deliveryInfo?.deliveredAt) && (
